...
import static io.github.izzyleung.zhihudailypurify.ui.view.SuggestionsAdapter.getColumnString;

public class IzzySearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public IzzySearchView(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(io.github.izzyleung.zhihudailypurify.R.layout.izzy_search_view, this, true);
...
//        final boolean showClose = hasText || (mIconifiedByDefault && !mExpandedInActionView);
    ...
    private final OnItemSelectedListener mOnItemSelectedListener = new OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            IzzySearchView.this.onItemSelected(position);
        }
